    ...
    >
      ...
      >
        <div className="flex items-center gap-2 mb-2.5">
          ...
          <span className="text-[10px] uppercase tracking-[0.12em] font-semibold text-white/35">Live Weather</span>
        ...
        <div className="flex items-center gap-5">
          <div className="flex items-center gap-2.5">
            <CloudRain size={14} className="text-[#9CA3AF]" />
            <div>
              ...
              <div className="text-lg font-bold text-white/90 leading-tight">
                ...
                <span className="text-[10px] text-white/35 ml-1">mm</span>
              </div>
            </div>
          </div>
          <div className="w-px h-8 bg-white/6" />
          <div className="flex items-center gap-2.5">
            <Thermometer size={14} className="text-[#9CA3AF]" />
            <div>
              ...
              <div className="text-lg font-bold text-white/90 leading-tight">
                ...
                <span className="text-[10px] text-white/35 ml-1">°C</span>
              </div>
            </div>
          </div>
        </div>
