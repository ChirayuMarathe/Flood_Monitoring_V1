...
export default function DashboardPage() {
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar bg-[#0B0D12]">
      <div className="p-6 space-y-5 max-w-[1440px]">
        {/* Page Header */}
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-[20px] font-semibold text-[#E1E4EA] tracking-tight">Dashboard</h2>
            <p className="text-[12px] text-[#525866] mt-0.5">
              Monitoring {mumbaiWards.length} administrative wards across Mumbai
            </p>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#13161D] border border-[#242832]">
              <Clock size={12} className="text-[#525866]" />
              <span className="text-[11px] text-[#8B919E] font-mono">
                Day {timeIndex + 1} — Jul {timeSeriesData[timeIndex]?.day}
              </span>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#13161D] border border-[#242832]">
              <span className="w-1.5 h-1.5 rounded-full bg-[#5B8DEF]" />
              <span className="text-[11px] font-medium text-[#8B919E]">Online</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <RainfallChart />
          {/* Quick Access Card */}
          <div className="rounded-lg bg-[#13161D] border border-[#242832] flex flex-col">
            <div className="px-4 py-3 border-b border-[#242832]">
              <h3 className="text-[13px] font-semibold text-[#E1E4EA]">Quick Access</h3>
            </div>
            <div className="flex-1 p-3 space-y-2">
              <Link href="/map" className="flex items-center justify-between px-3 py-2.5 rounded-lg bg-[#1A1E27] border border-[#242832] hover:border-[#5B8DEF]/30 transition-colors group">
                <div>
                  <p className="text-[12px] font-medium text-[#C1C5CD] group-hover:text-[#E1E4EA]">Open Live Map</p>
                  <p className="text-[10px] text-[#525866] mt-0.5">3D geospatial view</p>
                </div>
                <ArrowUpRight size={14} className="text-[#525866] group-hover:text-[#5B8DEF] transition-colors" />
              </Link>
              <div className="px-3 py-2.5 rounded-lg bg-[#1A1E27] border border-[#242832]">
                <p className="text-[12px] font-medium text-[#C1C5CD]">Critical Wards</p>
              ...
              <div className="px-3 py-2.5 rounded-lg bg-[#1A1E27] border border-[#242832]">
                <div className="flex items-center justify-between">
                  <p className="text-[12px] font-medium text-[#C1C5CD]">Rainfall 3-Day</p>
                  <p className="text-[14px] font-semibold text-[#E1E4EA]">{td.rainfall_3day_sum}<span className="text-[10px] text-[#525866] ml-0.5">mm</span></p>
                </div>
                <div className="mt-1.5 w-full h-1 rounded-full bg-[#242832] overflow-hidden">
                  <div
